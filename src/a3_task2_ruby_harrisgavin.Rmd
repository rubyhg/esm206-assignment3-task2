...
- *I didn't get a warning, but I can see that the name in line 49 had two dashes originally, and the name after the third dash has been dropped from this new data set. Line 49 has Ki in name_1 and Adi in name_2.*
...
gasol_shots_month <- gasol_hookshots %>% 
  count(Month)
